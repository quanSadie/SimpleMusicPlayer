...
a:hover { text-shadow: 10px 10px 20px #ff0000; }
...
box-shadow: 5px 5px grey;
	...
	<body style="background: url(resources/wpp.jpg);">
	<%
    ...
    <%	ArrayList<Song> myList = (ArrayList<Song>)request.getSession().getAttribute("favSongs");%>
<div class="navbar">
...
<div class="main">
	<div class="container">
		<div class="row">
			<div class="col-md-12">
				<h3 style="color: hotpink;font-family: monospace;font-weight: bold;">${name}'s favorite songs</h3>
			</div>
			<%
			int count = 0;
				for (Song s: myList) { %>
				...
				<input type="hidden" name="delID" id="delID" value="<%=s.getSongName()%>">
				<input type="submit" class="button-33" role="button" value="Remove from favorite">
				</form>
			</div>
		...
		<div class="row">
			<div class="col-md-12">
				<h3 style="color: hotpink;font-family: monospace;font-weight: bold;">Coming soon</h3>
			</div>
			<div class="col-md-2">

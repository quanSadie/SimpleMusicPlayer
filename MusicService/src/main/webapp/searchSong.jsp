...
margin-right: 115px;
    ...
    <%	ArrayList<Song> searchList = (ArrayList<Song>)request.getSession().getAttribute("songSearch");%>
<div class="navbar">
...
<div class="main">
	<div class="container">
		<div class="row">
			<div class="col-md-12">
				<h3 style="color: pink;font-family: monospace;font-weight: bold;">Matched result(s)</h3>
			</div>
			<%
			int count = 0;
		...
		<div class="row">
			<div class="col-md-12">
				<h3 style="color: pink;">Coming soon</h3>
			</div>
			<div class="col-md-2">
